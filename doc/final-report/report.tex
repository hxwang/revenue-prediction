...
\begin{figure}[!ht] %  figure placement: here, top, bottom, or page
   \centering
   \subfigure[]{\includegraphics[width=.48\linewidth]{figs/correlation_train.png} \label{fig_corr_train}}   
   \subfigure[]{\includegraphics[width=.48\linewidth]{figs/correlation_test.png}  \label{fig_corr_test}}
