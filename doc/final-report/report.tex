...
\begin{figure*}[th]
\centering
\subfigure[GradientBoostingRegressor]{\includegraphics[width=.49\textwidth, clip=true, trim ={30mm 5mm 30mm 20mm}]{figs/predict_results_gboost.PNG}\label{fig:gboost}}
\subfigure[svm.NuSVR]{\includegraphics[width=.49\textwidth, clip=true, trim ={30mm 5mm 30mm 20mm}]{figs/predict_results_nusvr.PNG}\label{fig:usvr}}
\subfigure[KNeighborsRegressor]{\includegraphics[width=.49\textwidth, clip=true, trim ={30mm 5mm 30mm 20mm}]{figs/predict_results_knn.PNG}\label{fig:knn}}
\subfigure[Ensemble]{\includegraphics[width=.49\textwidth, clip=true, trim ={30mm 5mm 30mm 20mm}]{figs/predict_results_ensemble.PNG}\label{fig:ensemble}}
\caption{
